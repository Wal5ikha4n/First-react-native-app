...
export default function RoshanService({ navigation }) {
    return (
        
          <View style={styles.container}>
            
              
              <Image style={styles.image} source={require("../assets/Roshan-2.jpg")}></Image>
              <TouchableOpacity onPress={()=>{Linking.openURL('tel:*444#');}} style={styles.icons}>
                <Icon name="bank" size={33} color="#DE9803" />
                <Text style={styles.icones1}>My Balance</Text>
              </TouchableOpacity>
              
              <TouchableOpacity onPress={()=>{Linking.openURL('tel:*222#');}} style={styles.icons1}>
                <Icon name="plus-circle" size={33} color="#0092FF" />
                <Text style={styles.icones2}>Add Credit</Text>
              </TouchableOpacity>
              
              <TouchableOpacity onPress={()=>{Linking.openURL('tel:*122#');}} style={styles.icons2}>
                <Icon name="money" size={33} color="#FF6600" />
                <Text style={styles.icones3}>Loan</Text>
              </TouchableOpacity>
              
              <TouchableOpacity onPress={()=> {Linking.openURL('tel:*123#')}} style={styles.icons3}>
                <Icon name="send-o" size={33} color="#0E9100" />
                <Text style={styles.icones4}>Send Credit</Text>
              </TouchableOpacity>
              
              <TouchableOpacity onPress={()=> {Linking.openURL('tel:*555*4*8*1#')}} style={styles.icons4}>
                <Icon name="signal" size={33} color="#408F00" />
                <Text style={styles.icones5}>3G Activate</Text>
              </TouchableOpacity>
              
              <TouchableOpacity onPress={()=> {Linking.openURL('tel:*500#')}} style={styles.icons5}>
                <Icon name="send" size={33} color="#FF6C00" />
                <Text style={styles.icones6}>Internet Transfer</Text>
              </TouchableOpacity>
              
              <TouchableOpacity onPress={()=> {Linking.openURL('tel:*200#')}} style={styles.icons6}>
